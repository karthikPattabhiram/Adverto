 ...
 */
 ...
 module.exports = async (client) => {
    ...
    client.on("ready", async (client) => {
        ...
        await client.guilds.cache.get("879635224487682099").commands.set(ArrayOfApplicationCommands); // if you want to update only one guild (instant update)
        console.log("Commands Loaded!")
        client.user.setActivity(" Over Veno", { type: "WATCHING" });
